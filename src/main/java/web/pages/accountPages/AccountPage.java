...
public class AccountPage extends BasePage {
    ...
    @FindBy(xpath = "//*[@data-testid='account_status_label']")
    private WebElement accountStatus;

    @FindBy(xpath = "//*[@data-testid='icon-ruble']")
    private WebElement rubleImage;

    @FindBy(xpath = "//*[@data-testid='icon-dollar']")
    private WebElement dollarImage;

    @FindBy(xpath = "//*[@data-testid='icon-euro']")
