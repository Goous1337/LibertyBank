...
public final class ApiEndpoints {
    ...
    public static final String CREDIT_BACKGROUND = "credit/api/v1/products/form?id";
    public static final String DEPOSIT_PRODUCTS_OFFER = "deposits/api/v1/deposit-product/";
    public static final String CREDIT_PRODUCTS = "/credit/api/v1/products";
    public static final String CREDIT_PRODUCTS_INFO = "credit/api/v1/products/3";
    public static final String INVALID_CREDIT_PRODUCTS = "credits/api/v1/credit-product/.";
    public static final String INVALID_CREDIT_PRODUCT = "credit/api/v1/products/7";
    ...
    public static final String CREDIT_BODY = "credit/api/v1/orders";
    public static final String CREDIT_ORDER_STATUS = "credit/api/v1/orders/status";
